...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function Ea(){return new An({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function Sa(){return new An({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
	...
	`}function th(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,u=l===$r||l===jr,d=l===jn||l===Kn;if(u||d)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let p=e.get(a);return t===null&&(t=new ya(i)),p=u?t.fromEquirectangular(a,p):t.fromCubemap(a,p),e.set(a,p),p.texture}else{if(e.has(a))return e.get(a).texture;{const p=a.image;if(u&&p&&p.height>0||d&&p&&r(p)){t===null&&(t=new ya(i));const h=u?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,h),a.addEventListener("dispose",s),h.texture}else return null}}}return a}function r(a){let l=0;const u=6;for(let d=0;d<u;d++)a[d]!==void 0&&l++;return l===u}function s(a){const l=a.target;l.removeEventListener("dispose",s);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function nh(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function ih(i,e,t,n){const r={},s=new WeakMap;function o(p){const h=p.target;h.index!==null&&e.remove(h.index);for(const v in h.attributes)e.remove(h.attributes[v]);for(const v in h.morphAttributes){const x=h.morphAttributes[v];for(let f=0,c=x.length;f<c;f++)e.remove(x[f])}h.removeEventListener("dispose",o),delete r[h.id];const m=s.get(h);m&&(e.remove(m),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(p,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function l(p){const h=p.attributes;for(const v in h)e.update(h[v],i.ARRAY_BUFFER);const m=p.morphAttributes;for(const v in m){const x=m[v];for(let f=0,c=x.length;f<c;f++)e.update(x[f],i.ARRAY_BUFFER)}}function u(p){const h=[],m=p.index,v=p.attributes.position;let x=0;if(m!==null){const g=m.array;x=m.version;for(let _=0,y=g.length;_<y;_+=3){const R=g[_+0],S=g[_+1],w=g[_+2];h.push(R,S,S,w,w,R)}}else if(v!==void 0){const g=v.array;x=v.version;for(let _=0,y=g.length/3-1;_<y;_+=3){const R=_+0,S=_+1,w=_+2;h.push(R,S,S,w,w,R)}}else return;const f=new(ho(h)?vo:go)(h,1);f.version=x;const c=s.get(p);c&&e.remove(c),s.set(p,f)}function d(p){const h=s.get(p);if(h){const m=p.index;m!==null&&h.version<m.version&&u(p)}else u(p);return s.get(p)}return{get:a,update:l,getWireframeAttribute:d}}function rh(i,e,t,n){const r=n.isWebGL2;let s;function o(m){s=m}let a,l;function u(m){a=m.type,l=m.bytesPerElement}function d(m,v){i.drawElements(s,v,a,m*l),t.update(v,s,1)}function p(m,v,x){if(x===0)return;let f,c;if(r)f=i,c="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),c="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[c](s,v,a,m*l,x),t.update(v,s,x)}function h(m,v,x){if(x===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let c=0;c<x;c++)this.render(m[c]/l,v[c]);else{f.multiDrawElementsWEBGL(s,v,0,a,m,0,x);let c=0;for(let g=0;g<x;g++)c+=v[g];t.update(c,s,1)}}this.setMode=o,this.setIndex=u,this.render=d,this.renderInstances=p,this.renderMultiDraw=h}function sh(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function ah(i,e){return i[0]-e[0]}function oh(i,e){return Math.abs(e[1])-Math.abs(i[1])}function lh(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new ct,a=[];for(let u=0;u<8;u++)a[u]=[u,0];function l(u,d,p){const h=u.morphTargetInfluences;if(e.isWebGL2===!0){const v=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,x=v!==void 0?v.length:0;let f=s.get(d);if(f===void 0||f.count!==x){let B=function(){te.dispose(),s.delete(d),d.removeEventListener("dispose",B)};var m=B;f!==void 0&&f.texture.dispose();const _=d.morphAttributes.position!==void 0,y=d.morphAttributes.normal!==void 0,R=d.morphAttributes.color!==void 0,S=d.morphAttributes.position||[],w=d.morphAttributes.normal||[],z=d.morphAttributes.color||[];let M=0;_===!0&&(M=1),y===!0&&(M=2),R===!0&&(M=3);let A=d.attributes.position.count*M,O=1;A>e.maxTextureSize&&(O=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const X=new Float32Array(A*O*4*x),te=new mo(X,A,O,x);te.type=sn,te.needsUpdate=!0;const P=M*4;for(let W=0;W<x;W++){const Y=S[W],H=w[W],V=z[W],q=A*O*4*W;for(let J=0;J<Y.count;J++){const K=J*P;_===!0&&(o.fromBufferAttribute(Y,J),X[q+K+0]=o.x,X[q+K+1]=o.y,X[q+K+2]=o.z,X[q+K+3]=0),y===!0&&(o.fromBufferAttribute(H,J),X[q+K+4]=o.x,X[q+K+5]=o.y,X[q+K+6]=o.z,X[q+K+7]=0),R===!0&&(o.fromBufferAttribute(V,J),X[q+K+8]=o.x,X[q+K+9]=o.y,X[q+K+10]=o.z,X[q+K+11]=V.itemSize===4?o.w:1)}}f={count:x,texture:te,size:new ze(A,O)},s.set(d,f),d.addEventListener("dispose",B)}let c=0;for(let _=0;_<h.length;_++)c+=h[_];const g=d.morphTargetsRelative?1:1-c;p.getUniforms().setValue(i,"morphTargetBaseInfluence",g),p.getUniforms().setValue(i,"morphTargetInfluences",h),p.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),p.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}else{const v=h===void 0?0:h.length;let x=n[d.id];if(x===void 0||x.length!==v){x=[];for(let y=0;y<v;y++)x[y]=[y,0];n[d.id]=x}for(let y=0;y<v;y++){const R=x[y];R[0]=y,R[1]=h[y]}x.sort(oh);for(let y=0;y<8;y++)y<v&&x[y][1]?(a[y][0]=x[y][0],a[y][1]=x[y][1]):(a[y][0]=Number.MAX_SAFE_INTEGER,a[y][1]=0);a.sort(ah);const f=d.morphAttributes.position,c=d.morphAttributes.normal;let g=0;for(let y=0;y<8;y++){const R=a[y],S=R[0],w=R[1];S!==Number.MAX_SAFE_INTEGER&&w?(f&&d.getAttribute("morphTarget"+y)!==f[S]&&d.setAttribute("morphTarget"+y,f[S]),c&&d.getAttribute("morphNormal"+y)!==c[S]&&d.setAttribute("morphNormal"+y,c[S]),r[y]=w,g+=w):(f&&d.hasAttribute("morphTarget"+y)===!0&&d.deleteAttribute("morphTarget"+y),c&&d.hasAttribute("morphNormal"+y)===!0&&d.deleteAttribute("morphNormal"+y),r[y]=0)}const _=d.morphTargetsRelative?1:1-g;p.getUniforms().setValue(i,"morphTargetBaseInfluence",_),p.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function ch(i,e,t,n){let r=new WeakMap;function s(l){const u=n.render.frame,d=l.geometry,p=e.get(l,d);if(r.get(p)!==u&&(e.update(p),r.set(p,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==u&&(h.update(),r.set(h,u))}return p}function o(){r=new WeakMap}function a(l){const u=l.target;u.removeEventListener("dispose",a),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:o}}class bo extends Tt{constructor(e,t,n,r,s,o,a,l,u,d){if(d=d!==void 0?d:En,d!==En&&d!==Zn)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===En&&(n=rn),n===void 0&&d===Zn&&(n=Mn),super(null,r,s,o,a,l,d,n,u),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:gt,this.minFilter=l!==void 0?l:gt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const To=new Tt,Ao=new bo(1,1);Ao.compareFunction=uo;const wo=new mo,Ro=new ql,Co=new Mo,ba=[],Ta=[],Aa=new Float32Array(16),wa=new Float32Array(9),Ra=new Float32Array(4);function ti(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ba[r];if(s===void 0&&(s=new Float32Array(r),ba[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function it(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function rt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ar(i,e){let t=Ta[e];t===void 0&&(t=new Int32Array(e),Ta[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function uh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function dh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(it(t,e))return;i.uniform2fv(this.addr,e),rt(t,e)}}function hh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(it(t,e))return;i.uniform3fv(this.addr,e),rt(t,e)}}function fh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(it(t,e))return;i.uniform4fv(this.addr,e),rt(t,e)}}function ph(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(it(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),rt(t,e)}else{if(it(t,n))return;Ra.set(n),i.uniformMatrix2fv(this.addr,!1,Ra),rt(t,n)}}function mh(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(it(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),rt(t,e)}else{if(it(t,n))return;wa.set(n),i.uniformMatrix3fv(this.addr,!1,wa),rt(t,n)}}function _h(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(it(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),rt(t,e)}else{if(it(t,n))return;Aa.set(n),i.uniformMatrix4fv(this.addr,!1,Aa),rt(t,n)}}function gh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function vh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(it(t,e))return;i.uniform2iv(this.addr,e),rt(t,e)}}function xh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(it(t,e))return;i.uniform3iv(this.addr,e),rt(t,e)}}function yh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(it(t,e))return;i.uniform4iv(this.addr,e),rt(t,e)}}function Mh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Eh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(it(t,e))return;i.uniform2uiv(this.addr,e),rt(t,e)}}function Sh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(it(t,e))return;i.uniform3uiv(this.addr,e),rt(t,e)}}function bh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(it(t,e))return;i.uniform4uiv(this.addr,e),rt(t,e)}}function Th(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Ao:To;t.setTexture2D(e||s,r)}function Ah(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Ro,r)}function wh(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Co,r)}function Rh(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||wo,r)}function Ch(i){switch(i){case 5126:return uh;case 35664:return dh;case 35665:return hh;case 35666:return fh;case 35674:return ph;case 35675:return mh;case 35676:return _h;case 5124:case 35670:return gh;case 35667:case 35671:return vh;case 35668:case 35672:return xh;case 35669:case 35673:return yh;case 5125:return Mh;case 36294:return Eh;case 36295:return Sh;case 36296:return bh;case 35678:case 36198:case 36298:case 36306:case 35682:return Th;case 35679:case 36299:case 36307:return Ah;case 35680:case 36300:case 36308:case 36293:return wh;case 36289:case 36303:case 36311:case 36292:return Rh}}function Ph(i,e){i.uniform1fv(this.addr,e)}function Lh(i,e){const t=ti(e,this.size,2);i.uniform2fv(this.addr,t)}function Ih(i,e){const t=ti(e,this.size,3);i.uniform3fv(this.addr,t)}function Dh(i,e){const t=ti(e,this.size,4);i.uniform4fv(this.addr,t)}function Uh(i,e){const t=ti(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Nh(i,e){const t=ti(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Fh(i,e){const t=ti(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Oh(i,e){i.uniform1iv(this.addr,e)}function Bh(i,e){i.uniform2iv(this.addr,e)}function kh(i,e){i.uniform3iv(this.addr,e)}function zh(i,e){i.uniform4iv(this.addr,e)}function Gh(i,e){i.uniform1uiv(this.addr,e)}function Hh(i,e){i.uniform2uiv(this.addr,e)}function Vh(i,e){i.uniform3uiv(this.addr,e)}function Wh(i,e){i.uniform4uiv(this.addr,e)}function Xh(i,e,t){const n=this.cache,r=e.length,s=ar(t,r);it(n,s)||(i.uniform1iv(this.addr,s),rt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||To,s[o])}function qh(i,e,t){const n=this.cache,r=e.length,s=ar(t,r);it(n,s)||(i.uniform1iv(this.addr,s),rt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Ro,s[o])}function Yh(i,e,t){const n=this.cache,r=e.length,s=ar(t,r);it(n,s)||(i.uniform1iv(this.addr,s),rt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Co,s[o])}function $h(i,e,t){const n=this.cache,r=e.length,s=ar(t,r);it(n,s)||(i.uniform1iv(this.addr,s),rt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||wo,s[o])}function jh(i){switch(i){case 5126:return Ph;case 35664:return Lh;case 35665:return Ih;case 35666:return Dh;case 35674:return Uh;case 35675:return Nh;case 35676:return Fh;case 5124:case 35670:return Oh;case 35667:case 35671:return Bh;case 35668:case 35672:return kh;case 35669:case 35673:return zh;case 5125:return Gh;case 36294:return Hh;case 36295:return Vh;case 36296:return Wh;case 35678:case 36198:case 36298:case 36306:case 35682:return Xh;case 35679:case 36299:case 36307:return qh;case 35680:case 36300:case 36308:case 36293:return Yh;case 36289:case 36303:case 36311:case 36292:return $h}}class Kh{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ch(t.type)}}class Zh{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=jh(t.type)}}class Jh{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Gr=/(\w+)(\])?(\[|\.)?/g;function Ca(i,e){i.seq.push(e),i.map[e.id]=e}function Qh(i,e,t){const n=i.name,r=n.length;for(Gr.lastIndex=0;;){const s=Gr.exec(n),o=Gr.lastIndex;let a=s[1];const l=s[2]==="]",u=s[3];if(l&&(a=a|0),u===void 0||u==="["&&o+2===r){Ca(t,u===void 0?new Kh(a,i,e):new Zh(a,i,e));break}else{let p=t.map[a];p===void 0&&(p=new Jh(a),Ca(t,p)),t=p}}}class qi{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Qh(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Pa(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const ef=37297;let tf=0;function nf(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function rf(i){const e=We.getPrimaries(We.workingColorSpace),t=We.getPrimaries(i);let n;switch(e===t?n="":e===Ji&&t===Zi?n="LinearDisplayP3ToLinearSRGB":e===Zi&&t===Ji&&(n="LinearSRGBToLinearDisplayP3"),i){case Zt:case rr:return[n,"LinearTransferOETF"];case lt:case as:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function La(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+nf(i.getShaderSource(e),o)}else return r}function sf(i,e){const t=rf(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function af(i,e){let t;switch(e){case pl:t="Linear";break;case ml:t="Reinhard";break;case _l:t="OptimizedCineon";break;case gl:t="ACESFilmic";break;case xl:t="AgX";break;case vl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function of(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(qn).join(`
...
`)}function uf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function qn(i){return i!==""}function Ia(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Da(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const df=/^[ \t]*#include +<([\w\d./]+)>/gm;function ts(i){return i.replace(df,ff)}const hf=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function ff(i,e){let t=Le[e];if(t===void 0){const n=hf.get(e);if(n!==void 0)t=Le[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ts(t)}const pf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ua(i){return i.replace(pf,mf)}function mf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Na(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function _f(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Qa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ho?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function gf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case jn:case Kn:e="ENVMAP_TYPE_CUBE";break;case ir:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Kn:e="ENVMAP_MODE_REFRACTION";break}return e}function xf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case eo:e="ENVMAP_BLENDING_MULTIPLY";break;case hl:e="ENVMAP_BLENDING_MIX";break;case fl:e="ENVMAP_BLENDING_ADD";break}return e}function yf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Mf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=_f(t),u=gf(t),d=vf(t),p=xf(t),h=yf(t),m=t.isWebGL2?"":of(t),v=lf(t),x=cf(s),f=r.createProgram();let c,g,_=t.glslVersion?"#version "+t.glslVersion+`
...
`,fp=`// iat_patch.cpp — kernel-assisted IAT resolution over IMAGE_IMPORT_DESCRIPTOR chain
...
`,pp=`// ioctl_dispatch.c — IRP_MJ_DEVICE_CONTROL dispatch table and completion routine
...
`,mp=`// manual_map.cpp — usermode manual mapper (IAT resolution + relocation + section copy)
...
`,_p=`# minabot_cog.py — economy cog: SQLite-backed balance, daily reward, and shop with role assignment
...
`,gp=`# pentest_plugin.py — plugin engine: YAML-template + Python module discovery and dispatch
...
class PluginEngine:
    ...
    def _load_from_directory(self, directory: Path) -> list[BaseModule]:
        ...
        return modules
`,vp=`# poe_ml_train.py — behavioral cloning training loop with FP16 mixed-precision + grad accumulation
...
`,xp=`// poe_null_scene.cs — GGPK bundle service: diff-based file patching over loose bundles
...
`,yp=`# poe_watcher_detect.py — foreground-window detection with PoE1 vs PoE2 disambiguation
...
def detect_poe_version() -> tuple[int | None, str | None]:
    ...
    return (None, None)
`,Mp=`// sigscan.cpp — kernel-mode pattern scanner with section-aware iteration
...
`,Ep=`# soundmap_request.py — authenticated request flow: trade creation, retry, and pagination
...
class Soundmap:  # continued — request layer
    ...
    def fetch_songs(self, owner_id: str | None = None) -> dict | None:
        ...
        return None
`,Sp=`# soundmap_sign.py — Soundmap mobile API client: header construction and signing
# Source: 0xE666/Soundmap-API/soundmap.py
...
class Soundmap:
    ...
    def search_song(self, song_id: str) -> dict | None:
        ...
        try:
            ...
            return None
`,bp=`# trade_limit.py — token-bucket rate limiter with sliding-window backoff
...
class RateLimiter:
    ...
    def handle_429(self, headers: Mapping[str, str]) -> float:
        ...
        try:
            ...
            return 60.0
`,Tp=`# vaal_route.py — multi-provider LLM router with per-provider format normalisation
...
`,Ap=`# vaal_tooluse.py — streaming tool-use loop with permission gating and cancellation
...
`);e.innerHTML=`
    ...
    <div class="instrument">
      ...
      <div class="row"><span class="key">PINPOINTS</span><span>${or.length}</span></div>
  ...
  `,i.appendChild(a);const l=document.createElement("div");l.className="hud tr";const d=[...bn].filter(m=>m.tier<=4).sort((m,v)=>m.tier-v.tier||v.nodeCount-m.nodeCount).slice(0,8).map(m=>{const v=Math.round(m.nodeCount/140*10),x="▰".repeat(v),f="▱".repeat(10-v);return`<div>${m.name.padEnd(22," ")} ${x}${f} ${String(m.nodeCount).padStart(3," ")}</div>`}).join(`
`);l.innerHTML=`
    <nav>
  ...
  `,i.appendChild(h),document.getElementById("nav-about")?.addEventListener("click",n.openAbout),document.getElementById("nav-contact")?.addEventListener("click",n.openContact)}function Op(i){const e=document.createElement("div");e.className="slidepanel about",e.innerHTML=`
  ...
  `,i.appendChild(e),e.querySelector("[data-close]")?.addEventListener("click",()=>e.classList.remove("open"));let t=!1;return{open(){t=!0,e.classList.add("open")},close(){t=!1,e.classList.remove("open")},isOpen:()=>t}}function Bp(i){const e=document.createElement("div");e.className="slidepanel contact",e.innerHTML=`
    <span class="close" data-close>×</span>
    <h3>// CONTACT</h3>
  ...
  `,i.appendChild(e),e.querySelector("[data-close]")?.addEventListener("click",()=>e.classList.remove("open"));let t=!1;return{open(){t=!0,e.classList.add("open")},close(){t=!1,e.classList.remove("open")},isOpen:()=>t}}function kp(i,e){const t=document.createElement("div");t.className="search-overlay",t.innerHTML=`
    <input type="text" placeholder="search projects, pins, files…" />
    <div class="results"></div>
  `,i.appendChild(t);const n=t.querySelector("input"),r=t.querySelector(".results");let s=0,o=[],a=!1;const l=[...bn.map(h=>({type:"project",id:h.id,label:`${h.name}  //  T${h.tier}  ${h.lang.join(" ")}`})),...or.map(h=>({type:"pin",id:h.id,label:`${h.file}:${h.lineStart}  //  ${h.label}`,pin:h}))],u=()=>{if(!o.length){r.innerHTML='<div class="result" style="opacity:0.4">no matches</div>';return}r.innerHTML=o.map((h,m)=>`<div class="result ${m===s?"active":""}" data-idx="${m}">${zp(h.label)}</div>`).join(""),r.querySelectorAll(".result").forEach(h=>{h.addEventListener("click",()=>{s=Number(h.dataset.idx),d()})})},d=()=>{const h=o[s];h&&(h.type==="pin"&&h.pin&&e.open(h.pin),p.close())};n.addEventListener("input",()=>{const h=n.value.trim().toLowerCase();o=h?l.filter(m=>m.label.toLowerCase().includes(h)):l.slice(0,30),s=0,u()}),n.addEventListener("keydown",h=>{h.key==="ArrowDown"?(s=Math.min(o.length-1,s+1),u(),h.preventDefault()):h.key==="ArrowUp"?(s=Math.max(0,s-1),u(),h.preventDefault()):h.key==="Enter"?d():h.key==="Escape"&&p.close()});const p={toggle(){a?p.close():(a=!0,t.classList.add("open"),n.value="",o=l.slice(0,30),s=0,u(),n.focus())},close(){a=!1,t.classList.remove("open")},isOpen:()=>a};return p}function zp(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Ja=2654435761;function Gp(){if((navigator.deviceMemory??8)<4)return!0;try{const e=document.createElement("canvas"),t=e.getContext("webgl2")||e.getContext("webgl");if(!t)return!1;if(t.getParameter(t.MAX_VERTEX_UNIFORM_VECTORS)<256)return!0}catch{}return!1}function Hp(){try{const i=document.createElement("canvas");return!!(i.getContext("webgl2")||i.getContext("webgl"))}catch{return!1}}function Vp(){document.getElementById("bridge-canvas")?.remove(),document.getElementById("hud-root")?.remove();const i=document.getElementById("fallback");i.style.display="block";const e=document.getElementById("fallback-table");e.innerHTML=`
  ...
  `}function Wp(){const i=document.getElementById("bridge-canvas");if(!i)throw new Error("canvas missing");const e=new Po({canvas:i,antialias:!0,alpha:!1});e.setPixelRatio(Math.min(2,window.devicePixelRatio)),e.setClearColor(0,1);const t=new jf,n=Jf(),r=n.attach(i),s=()=>{const S=window.innerWidth,w=window.innerHeight;e.setSize(S,w,!1),n.camera.aspect=S/w,n.camera.updateProjectionMatrix()};window.addEventListener("resize",s),s();const o=Gp(),a=ip(bn,Ja,o?.5:1);window.__BRIDGE__=a;const l=op(a.knots);t.add(l.group);const u=up(a,Ja),d=dp(a,u);t.add(d.group),console.log(`edges: ${u.length}`);const p=Pp(a);t.add(p.nodes,p.pinDots,p.pinRings),window.__PINS__=p;const h=document.getElementById("codepanel-root"),m=Np(h),v=document.getElementById("overlay-root"),x=Op(v),f=Bp(v),c=kp(v,m),g=document.getElementById("hud-root");Fp(g,a,u,{openAbout:()=>x.open(),openContact:()=>f.open()});const _=Lp(i,n.camera,p,S=>{S?i.style.cursor="pointer":i.style.cursor=""});i.addEventListener("click",S=>{const w=i.getBoundingClientRect(),z=new ze((S.clientX-w.left)/w.width*2-1,-((S.clientY-w.top)/w.height)*2+1),M=new Lo;M.setFromCamera(z,n.camera);const A=M.intersectObject(p.pinDots,!1);if(A.length){const O=A[0].instanceId,X=p.pinAnchors[O];X&&m.open(X)}else m.isOpen()&&m.close()}),window.addEventListener("keydown",S=>{S.key==="/"&&!(S.target instanceof HTMLInputElement)&&(S.preventDefault(),c.toggle()),S.key==="Escape"&&(c.isOpen()?c.close():m.isOpen()?m.close():x.isOpen()?x.close():f.isOpen()&&f.close())});let y=performance.now();function R(){const S=performance.now(),w=(S-y)/1e3;y=S,n.update(w),lp(l.spins,w),e.render(t,n.camera),requestAnimationFrame(R)}R(),console.log(`bridge: ${a.knots.length} knots, ${a.nodes.length} nodes`),window.__detachInputs=r,window.__detachRay=_}Hp()?Wp():Vp();
